...
public class ApiClient {
    ...
    public Request buildRequest(String path, String method, List<Pair> queryParams, List<Pair> collectionQueryParams, Object body, Map<String, String> headerParams, Map<String, String> cookieParams, Map<String, Object> formParams, String[] authNames, ApiCallback callback) throws ApiException {
        ...
        if (StringUtils.isNotEmpty(appKey) && StringUtils.isNotEmpty(appSecret)) {
            ...
            String nonceStr = Long.toString(ran.nextLong());
            ...
            String signature = SignUtil.sign(buffer.readString(reqBody.contentType().charset()), timestamp, nonceStr, path, appSecret);

            reqBuilder.addHeader("Timestamp", timestamp);
            reqBuilder.addHeader("Noncestr", nonceStr);
            reqBuilder.addHeader("Signature", signature);
            reqBuilder.addHeader("Authorization", "Bearer " + appKey);
        }
